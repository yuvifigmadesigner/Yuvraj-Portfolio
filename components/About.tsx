...
const About: React.FC = () => {
  ...
  return (
    <>
      ...
      <main className="flex-1 flex flex-col justify-start px-6 md:px-12 relative z-10 text-white w-full max-w-7xl mx-auto pt-12 md:pt-24 pb-20 animate-fade-in">
          {/* Page Header */}
          <div className="mb-16 md:mb-20">
              <h1 className="text-5xl md:text-7xl font-medium tracking-tight mb-6">About.</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 mb-24 md:mb-32">
              ...
              {/* Left Column: Bio */}
              <div className="lg:col-span-7 space-y-6 text-lg md:text-xl text-white/80 leading-relaxed font-light">
                  <h2 className="text-xs font-mono uppercase tracking-widest text-white/50 mb-2">/ Who I Am</h2>
                  <p>
              ...
              <div className="lg:col-span-5 space-y-12">
                  {/* Certificates */}
                  <div>
                      <h2 className="text-xs font-mono uppercase tracking-widest text-white/50 mb-8">/ Certificates</h2>
                          ...
                          {[
                            ...
                            { title: "Figma UI UX Design Essentials", link: "https://www.udemy.com/certificate/UC-497b4213-0dc9-4aef-ac9c-d288f0765359/" },
                              ...
                              <a 
                                ...
                                className="group flex items-center justify-between p-3 -mx-3 rounded-lg hover:bg-white/5 transition-all duration-300 border border-transparent hover:border-white/5"
                              >
                                  <span className="text-white/70 group-hover:text-white transition-colors text-sm md:text-base font-light truncate pr-4">
                                    {cert.title}
                                  </span>
                                  <ArrowUpRight size={16} className="text-white/30 group-hover:text-white opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 shrink-0" />
                              </a>
                          ))}
                      </div>
                  </div>
                  ...
                  {/* Capabilities */}
                  <div>
                      <h2 className="text-xs font-mono uppercase tracking-widest text-white/50 mb-8">/ Capabilities</h2>
                      <div className="flex flex-wrap gap-2">
                          {['Product Strategy', 'UI/UX Design', 'Design Systems', 'Prototyping', 'User Research'].map((item) => (
                              <span key={item} className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-md text-sm text-white/70 hover:bg-white/10 transition-colors cursor-default">
                                  {item}
                              </span>
                          ))}
                      </div>
          ...
          <div className="mb-24 md:mb-32">
            <h2 className="text-xs font-mono uppercase tracking-widest text-white/50 mb-8">/ My Hobbies</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Hobby 1 - Photography (Clickable) */}
                <div 
                  onClick={() => setShowGallery(true)}
                  className="p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-all duration-300 cursor-pointer group hover:scale-[1.02] hover:shadow-2xl"
                >
                    <div className="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center text-white mb-6 group-hover:bg-white group-hover:text-black transition-colors">
                        <Camera size={24} strokeWidth={1.5} />
                    </div>
                    <div className="flex justify-between items-center mb-2">
                      <h3 className="text-xl font-medium">Photography</h3>
                      <span className="text-xs text-white/40 uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity">View</span>
                    </div>
                ...
                <div className="p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-all duration-300">
                    <div className="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center text-white mb-6">
                        <Heart size={24} strokeWidth={1.5} />
                    </div>
                    <h3 className="text-xl font-medium mb-2">Volunteering</h3>
                    <p className="text-white/60 text-sm leading-relaxed">
          ...
          {/* FOOTER: CONTACT */}
          <div>
              <h2 className="text-xs font-mono uppercase tracking-widest text-white/50 mb-8">/ Get in Touch</h2>
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  ...
                  >
                      <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center text-white group-hover:bg-white group-hover:text-black transition-colors shrink-0">
                          <Mail size={20} />
                      </div>
                      <div className="overflow-hidden">
                          <div className="text-xs text-white/50 uppercase tracking-wider font-medium mb-0.5">Email</div>
                          <div className="text-sm text-white/90 font-medium truncate">yuvrajkumar0221@gmail.com</div>
                      </div>
                  </a>
                  ...
                  >
                      ...
                      <div>
                          <div className="text-xs text-white/50 uppercase tracking-wider font-medium mb-0.5">Phone</div>
                          <div className="text-sm text-white/90 font-medium">+91 76988 93369</div>
                      </div>
                  </a>
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="group flex items-center gap-4 p-5 rounded-2xl bg-white/5 border border-white/10 hover:bg-[#FFDD00]/10 hover:border-[#FFDD00]/30 transition-all duration-300 sm:col-span-2 lg:col-span-1"
                  >
                      <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center text-white group-hover:bg-[#FFDD00] group-hover:text-black transition-colors shrink-0">
                          <Coffee size={20} />
                      </div>
                      <div className="flex-1 flex justify-between items-center">
                          <div className="overflow-hidden mr-2">
                              <div className="text-xs text-white/50 uppercase tracking-wider font-medium mb-0.5 group-hover:text-[#FFDD00] transition-colors">Support</div>
                              <div className="text-sm text-white/90 font-medium truncate">Buy Me a Coffee</div>
                          </div>
                          <ArrowUpRight size={18} className="text-white/30 group-hover:text-[#FFDD00] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all shrink-0" />
                      </div>
                  </a>
              </div>
          </div>
